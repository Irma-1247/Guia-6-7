        ...
        <Modal
          ...
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              ...
              <Text>Uno de los principales platillos típicos.</Text>
              <Button
                title="cerrar"
                onPress={() => {
        ...
        <Modal
          ...
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              ...
              <Text>
                La ruta más conocida es la 'Ruta de la Flores', donde se
                recorren unos de los más pintorescos pueblos de El Salvador.
              </Text>
              <Button
                title="cerrar"
                onPress={() => {
